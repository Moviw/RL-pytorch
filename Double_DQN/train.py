...
from algo import Double_DQN  # from parl.algorithms import DQN
...
if __name__ == '__main__':
    ...
    model_save_path = relative_path+'\\Double DQN_model.pth'  # 模型参数保存地址
    ...
    algorithm = Double_DQN(model, gamma=GAMMA, lr=LEARNING_RATE)
