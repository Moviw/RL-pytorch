...
if __name__ == '__main__':
    ...
    model_save_path = relative_path+'\\Dueling DQN_model.pth'  # 模型参数保存地址
    ...
    model = VANet(obs_dim=obs_dim, act_dim=act_dim).to(device)
    algorithm = Dueling_DQN(model, gamma=GAMMA, lr=LEARNING_RATE)
